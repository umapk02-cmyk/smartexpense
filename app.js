        ...
        e("div",{style:{background:"#fff",borderRadius:12,padding:16,boxShadow:"0 1px 6px rgba(0,0,0,0.07)"}},
          ...
          e("div",{style:{marginBottom:12}},
            ...
            e("input",{type:"number",min:"0",value:newAmt,onChange:ev=>setNewAmt(ev.target.value),
              ...
              style:{width:"100%",padding:"11px 14px",border:"2px solid #e5e7eb",borderRadius:8,fontSize:18,outline:"none",textAlign:"right",fontWeight:700,color:"#1F4E79",boxSizing:"border-box"}})
          ),
            ...
            :dayRows.map(row=>{
              ...
              return e("div",{key:row.id,onClick:()=>setEditRow(row),style:{display:"flex",alignItems:"center",gap:10,padding:"10px 0",borderBottom:"1px solid #f3f4f6",cursor:"pointer"}},
                e("div",{style:{flex:1,minWidth:0}},
                  e("div",{style:{fontSize:13,fontWeight:600,color:"#111",marginBottom:2,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}},row.description||row.note||"—"),
                ...
                e("div",{style:{fontSize:15,fontWeight:800,color:src?.color||"#111",minWidth:70,textAlign:"right"}},"₹"+fmtN(row.amount)),
