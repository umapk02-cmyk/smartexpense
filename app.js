        ...
        e("div",{style:{background:"#fff",borderRadius:12,padding:14,boxShadow:"0 1px 6px rgba(0,0,0,0.07)"}},
          ...
          e("div",{style:{display:"flex",flexWrap:"wrap",gap:3,width:"100%"}},
            Array.from({length:days},(_,i)=>i+1).map(d=>{
              ...
              return e("button",{key:d,onClick:()=>setActiveDay(d),style:{width:28,height:28,borderRadius:6,border:isA?"2px solid #1F4E79":"1px solid #dde3ed",background:isA?"#1F4E79":dt>0?"#dbeafe":"#fff",color:isA?"#fff":dt>0?"#1F4E79":"#666",fontSize:11,fontWeight:isA||dt>0?700:400,cursor:"pointer",position:"relative"}},
